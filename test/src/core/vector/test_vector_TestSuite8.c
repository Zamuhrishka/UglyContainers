...
{
  uint8_t input[DEFAULT_CAPACITY] = {93274, 67793, 66, 54519, 771535, 10021, 90197, 907163, 562610, 1};
  uint8_t expected[DEFAULT_CAPACITY] = {1, 562610, 907163, 90197, 10021, 771535, 54519, 66, 67793, 93274};
...
{
  uint8_t input[DEFAULT_BIGGER_CAPACITY] = {93274,  67793, 66,    54519, 771535, 10021, 90197, 907163,
                                            562610, 1,     93274, 67793, 66,     54519, 771535};
  uint8_t expected[DEFAULT_BIGGER_CAPACITY] = {771535, 54519, 66,     67793, 93274, 1,     562610, 907163,
...
{
  uint8_t input[DEFAULT_CAPACITY] = {93274, 67793, 66, 54519, 771535, 10021, 90197, 907163, 562610, 1};
  uint8_t expected[DEFAULT_CAPACITY] = {93274, 67793, 66, 54519, 771535, 10021, 90197, 907163, 562610, 1};
  uint8_t output[DEFAULT_CAPACITY] = {};
...
void test_TestCase_6(void)
{
  ...
  uint8_t expected[DEFAULT_BIGGER_CAPACITY] = {93274,  67793, 66,    54519, 771535, 10021,  90197, 907163,
                                               562610, 1,     10021, 90197, 907163, 562610, 1};
  uint8_t output[DEFAULT_BIGGER_CAPACITY] = {};
...
{
  uint8_t input[DEFAULT_CAPACITY] = {93274, 11111, 67793, 33333, 66, 55555, 54519, 77777, 771535, 99999};
  uint8_t expected[DEFAULT_CAPACITY] = {93274, 11111, 67793, 33333, 66, 55555, 54519, 77777, 771535, 99999};
  uint8_t output[DEFAULT_CAPACITY] = {};
...
{
  uint8_t input[DEFAULT_BIGGER_CAPACITY] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                                            771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint8_t expected[DEFAULT_BIGGER_CAPACITY] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                                               771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint8_t output[DEFAULT_BIGGER_CAPACITY] = {};
...
{
  uint8_t input[] = {1, 562610, 907163, 90197, 10021, 771535, 54519, 66, 67793, 93274};
  uint8_t expected[] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                        771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint8_t output[sizeof(expected) / sizeof(uint8_t)] = {};
  ...
  uint8_t values[] = {11111, 33333, 55555, 77777, 99999};
...
{
  uint8_t input[] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                     771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint8_t expected[] = {93274, 67793, 66, 54519, 771535, 10021, 90197, 907163, 562610, 1};
  uint8_t output[sizeof(expected) / sizeof(uint8_t)] = {};
  uint8_t values[] = {11111, 33333, 55555, 77777, 99999};
...
void test_TestCase_14(void)
{
  uint8_t input[] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                     771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint8_t expected[] = {11111, 11111, 33333, 33333, 55555,  55555,  77777, 77777,
