...
void test_TestCase_1(void)
{
  struct test_ll_simple_struct input[] = {
      ...
      {.a = 0x77777777, .b = 0x7777, .c = 0x77}, {.a = 0xAAAAAAAA, .b = 0xAAAA, .c = 0xAA},
      {.a = 0x90909090, .b = 0x9090, .c = 0x90}, {.a = 0x90909090, .b = 0x9090, .c = 0x90},
      {.a = 0x56565656, .b = 0x5656, .c = 0x56}, {.a = 0x11111111, .b = 0x1111, .c = 0x11},
  };

  struct test_ll_simple_struct expected[] = {
      {.a = 0x11111111, .b = 0x1111, .c = 0x11}, {.a = 0x56565656, .b = 0x5656, .c = 0x56},
      {.a = 0x90909090, .b = 0x9090, .c = 0x90}, {.a = 0x90909090, .b = 0x9090, .c = 0x90},
      {.a = 0xAAAAAAAA, .b = 0xAAAA, .c = 0xAA}, {.a = 0x77777777, .b = 0x7777, .c = 0x77},
      {.a = 0x54545454, .b = 0x5454, .c = 0x54}, {.a = 0x66666666, .b = 0x6666, .c = 0x66},
      {.a = 0x67676767, .b = 0x6767, .c = 0x67}, {.a = 0x93939393, .b = 0x9393, .c = 0x93},
  };
