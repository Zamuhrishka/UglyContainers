...
void test_init(void)
{
    TEST_MESSAGE("Stack Complex Tests For 32-bit Data");
}
...
void test_TestCase_1(void)
{
    ...
    TEST_MESSAGE("Stack push/pop test");
...
void test_TestCase_2(void)
{
    ...
    TEST_MESSAGE("Stack push/peek test");
...
void test_TestCase_3(void)
{
    ...
    TEST_MESSAGE("Stack push/peek size test");
...
void test_TestCase_4(void)
{
    ...
    TEST_MESSAGE("Stack push/pop size test");
