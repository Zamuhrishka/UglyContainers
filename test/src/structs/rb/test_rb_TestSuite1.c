...
void test_init(void)
{
    TEST_MESSAGE("RingBuffer Simple Tests For");
}
...
void test_TestCase_1(void)
{
    ...
    TEST_MESSAGE("RingBuffer ADD test");
...
void test_TestCase_2(void)
{
    ...
    TEST_MESSAGE("RingBuffer EMPTY test");
...
void test_TestCase_3(void)
{
    ...
    TEST_MESSAGE("RingBuffer SIZE test");
...
void test_TestCase_4(void)
{
    ...
    TEST_MESSAGE("RingBuffer GET test");
...
void test_TestCase_5(void)
{
    ...
    TEST_MESSAGE("RingBuffer PEEK test");
