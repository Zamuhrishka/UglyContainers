/**
 * @file    test_Alg_Equal_TestSuite4.c
 * @author  Aliaksander Kavalchuk (aliaksander.kavalchuk@gmail.com)
 * @brief   Tests for the 'equal' function for containers based on vector stores `structure` data.
 *
...
{
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with empty vector containers stores `structure` data");
...
void test_TestCase_1(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with one empty and one full vector  container stores `structure` data");
...
void test_TestCase_3(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two equal full vector containers stores `structure` data");
...
void test_TestCase_4(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two different full vector containers stores `structure` data");
