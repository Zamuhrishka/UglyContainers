 ...
 * @brief   Tests for the 'equal' function for containers based on vector stores `uint32_t` data.
 *
...
{
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with empty vector containers stores `uint32_t` data");
...
void test_TestCase_1(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with one empty and one full vector  container stores `uint32_t` data");
...
void test_TestCase_3(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two equal full vector containers stores `uint32_t` data");
...
void test_TestCase_4(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two different full vector containers stores `uint32_t` data");
