 ...
 * @brief   Tests for the 'equal' function for containers based on linked list ans stores `uint16_t` data.
 *
...
{
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with empty linked list containers stores `uint16_t` data");
...
void test_TestCase_1(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with one empty and one full linked list  container stores `uint16_t` data");
...
void test_TestCase_3(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two equal full linked list containers stores `uint16_t` data");
...
void test_TestCase_4(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two different full linked list containers stores `uint16_t` data");
