 ...
 * @brief   Tests for the 'equal' function for containers based on vector and stores `uint8_t` data.
 *
...
/**
 * @brief Test for the 'equal' function with empty containers stores `uint8_t` data.
 *
...
{
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with empty vector containers stores `uint8_t` data");

  TEST_ASSERT_TRUE(uc_equal(.container1 = container1, .container2 = container2));
}

/**
 * @brief Test for the 'equal' function with one empty and one full container stores `uint8_t` data.
 *
 * This test case is designed to verify the behavior of the 'equal' function
...
void test_TestCase_1(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with one empty and one full vector  container stores `uint8_t` data");
...
/**
 * @brief Test for the 'equal' function with two equal full containers stores `uint8_t` data.
 *
 * This test case is designed to verify the behavior of the 'equal' function
...
void test_TestCase_3(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two equal full vector containers stores `uint8_t` data");
...
/**
 * @brief Test for the 'equal' function with two different full containers stores `uint8_t` data.
 *
 * This test case is designed to verify the behavior of the 'equal' function
...
void test_TestCase_4(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two different full vector containers stores `uint8_t` data");
