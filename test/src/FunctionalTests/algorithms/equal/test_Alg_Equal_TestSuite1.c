 ...
 * @brief   Tests for the 'equal' function for containers based on linked list ans stores `uint8_t` data.
 *
...
void test_TestCase_3(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two equal full linked list containers stores `uint8_t` data");
...
void test_TestCase_4(void)
{
  ...
  TEST_MESSAGE("[EQUAL]: Test for the 'equal' function with two different full linked list containers stores `uint8_t` data");
