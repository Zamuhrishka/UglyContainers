/**
 * @file    test_Alg_Transformation_TestSuite2.c
...
void setUp(void)
{
  container = container_create(sizeof(element_t), CONTAINER_VECTOR_BASED);
...
void test_TestCase_0(void)
{
  ...
  TEST_MESSAGE("[TRANSFORMATION]: Vector based container to `uint8_t` array transformation test");
...
void test_TestCase_1(void)
{
  ...
  TEST_MESSAGE("[TRANSFORMATION]: Array of `uint8_t` data to vector based container transformation test");
