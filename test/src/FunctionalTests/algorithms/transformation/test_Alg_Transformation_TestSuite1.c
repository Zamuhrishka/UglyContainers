/**
 * @file    test_Alg_Transformation_TestSuite1.c
 ...
 * between container based on Linked List representations and `uint8_t` data arrays.
...
void test_TestCase_0(void)
{
  ...
  TEST_MESSAGE("[TRANSFORMATION]: Linked list based container to `uint8_t` array transformation test");
...
void test_TestCase_1(void)
{
  ...
  TEST_MESSAGE("[TRANSFORMATION]: Array of `uint8_t` data to linked list based container transformation test");
