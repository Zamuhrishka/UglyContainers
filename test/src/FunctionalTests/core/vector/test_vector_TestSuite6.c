/**
 * @file    test_vector_TestSuite6.c
 * @author  Aleksander Kovalchuk (aliaksander.kavalchuk@gmail.com)
 * @brief   Set of simple unit tests for Vector 32-bit data. This list of tests
...
{
  uint32_t input[DEFAULT_BIGGER_CAPACITY] = {93274,  67793, 66,    54519, 771535, 10021, 90197, 907163,
                                             562610, 1,     93274, 67793, 66,     54519, 771535};
  uint32_t expected[DEFAULT_BIGGER_CAPACITY] = {771535, 54519, 66,     67793, 93274, 1,     562610, 907163,
...
void test_TestCase_6(void)
{
  ...
  uint32_t expected[DEFAULT_BIGGER_CAPACITY] = {93274,  67793, 66,    54519, 771535, 10021,  90197, 907163,
                                                562610, 1,     10021, 90197, 907163, 562610, 1};
  uint32_t output[DEFAULT_BIGGER_CAPACITY] = {};
...
{
  uint32_t input[DEFAULT_BIGGER_CAPACITY] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                                             771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint32_t expected[DEFAULT_BIGGER_CAPACITY] = {93274,  11111, 67793, 33333, 66,     55555,  54519, 77777,
                                                771535, 99999, 10021, 90197, 907163, 562610, 1};
  uint32_t output[DEFAULT_BIGGER_CAPACITY] = {};
